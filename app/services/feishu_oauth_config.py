"""Feishu OAuth configuration, input validation, and shared error contracts."""
...
FEISHU_OPEN_ID = re.compile(r"^ou[-_][A-Za-z0-9_-]+$")
...
def valid_feishu_open_id(value: str) -> bool:
    return 8 <= len(value) <= 128 and FEISHU_OPEN_ID.fullmatch(value) is not None
