"""Feishu browser-login orchestration behind the Identity boundary."""
...
class ExternalOAuthError(Exception):
...
class FeishuLoginService:
    ...
    async def exchange_code(
        ...
        try:
            ...
            raise ExternalOAuthError(exc.stage) from exc
...
def legacy_authorization_url(redirect_uri: str, state: str = "") -> str:
    """Preserve the original direct authorization-URL compatibility endpoint."""
    return feishu_client.oauth_authorize_url(redirect_uri, state)
