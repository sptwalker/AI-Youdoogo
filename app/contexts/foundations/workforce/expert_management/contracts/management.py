"""Published commands and object interface for Expert Management."""
...
class ExpertManagementPort(Protocol):
    """Published Expert API with no persistence or delivery framework parameters."""
